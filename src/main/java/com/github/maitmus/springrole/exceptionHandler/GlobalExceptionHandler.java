...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CommonErrorResponse> handleConflictException(ConflictException e) {
        HttpStatus status = HttpStatus.CONFLICT;
        log.error(e.getMessage(), e);
        return new ResponseEntity<>(new CommonErrorResponse(status.value(), "Conflict"), status);
    }
    ...
    public ResponseEntity<CommonErrorResponse> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
        ...
        log.error(e.getMessage());
        return new ResponseEntity<>(new CommonErrorResponse(status.value(), "Method Not Allowed"), status);
    }
